...
if __name__=='__main__':
    ...
    #s=ReadStackMat('stack_small.mat').GetOutput()
    #s=ReadStackMat('WaterShed1_N_Baseline_20190920_Ref_DamsehSeg_AfterRemovePialManually.mat').GetOutput()
    #s=ReadStackMat('WaterShed1_N_Baseline_20190920_Ref_DamsehSeg_AfterRemovePialManually.mat').GetOutput()
    #s=ReadStackMat('change.mat').GetOutput()
    
    #s=ReadStackMat('W2R190903BL_Ref_resize_finishremove_zxy_geoloss_aug.mat').GetOutput()   
    s=ReadStackMat('W2R190903BL_Ref_resize_finishremove_zxy.mat').GetOutput()
