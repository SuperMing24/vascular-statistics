    ...
    def UpdateWithStitching(self, size, 
        ...
        for inds in patchesid_:
            ...
            if is_parallel: # in parallel
                ...
                ray.init()
                print("after initial:%d"%countingCHW)
                subpatches=[ray.put(patches[ind]) for ind in inds]
                print("after subpatches%d"%countingCHW)
                ...
                print("after construct%d"%countingCHW)
                subgraphs=[ray.get(g) for g in subgraphs]
                print("before shutdown%d"%countingCHW)
                ray.shutdown()
                graphs.append(subgraphs)
                
                print("patch construction:%d"%countingCHW)
